...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"triviaID" forIndexPath:indexPath];
    
    FISTrivium *currentContent = self.trivia[indexPath.row];
    cell.textLabel.text = currentContent.content;
